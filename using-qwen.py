...
def get_response(processor, model, prompt, tokens, image_inputs, video_inputs):
...
def run_generation(lang, questions, processor, model, timestamp_now, model_path, type_approach, is_images = False, stereotype_list = None):
    ...
    for question in tqdm(questions, desc="Processing questions"):
        ...
        answer_not_extracted = get_response(processor, model, prompt_question, 256, image_inputs, video_inputs)[0]
    ...
    if is_images:
        file_name =  "Qwen_" + type_approach + "_" + lang + "_" + fixed_part_type_generation + "_" + timestamp_now + ".json"
    else:
        file_name =  "Qwen_" + lang + "_" + fixed_part_type_generation + "_" + timestamp_now + ".json"
...
def main(args):
    ...
    if type_approach == "cot":
        ...
        answer_stereotype_list = get_response(processor, model, prompt, 512, None, None)[0]
